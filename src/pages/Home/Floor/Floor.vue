        ...
        <div class="title clearfix">
          ...
          <div class="fr">
            <ul class="nav-tabs clearfix">
              <li class="active" v-for="(item, index) in floorItem.navList" :key="index">
        ...
        <div class="tab-content">
          <div class="tab-pane">
            <div class="floor-1">
              <div class="blockgary">
                <ul class="jd-list">
                  <li v-for="(item, index) in floorItem.keywords" :key="index">{{item}}</li>
                </ul>
                <img :src="floorItem.imgUrl" />
              </div>
              <div class="floorBanner">
                <swiper :options="swiperOptions">
                  <swiper-slide v-for="item in floorItem.carouselList" :key="item.id">
